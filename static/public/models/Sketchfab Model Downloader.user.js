...
// @downloadURL https://update.greasyfork.org/scripts/479293/Sketchfab%20Model%20Downloader.user.js
// @updateURL https://update.greasyfork.org/scripts/479293/Sketchfab%20Model%20Downloader.meta.js
// ==/UserScript==
...
(function () {
    ...
    addbtnfunc = function () {
        ...
        if (p && !button_dw) {
            ...
            btn.innerHTML = "<pre style='color: red; background-color: #e74c3c; border: none; color: white; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; border-radius: 8px;'>DOWNLOAD</pre>";
